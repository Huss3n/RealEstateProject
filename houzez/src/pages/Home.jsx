      ...
      <div className="overflow-hidden">
          ...
          <Container maxW={"7xl"}>
            <Stack align={"center"} spacing={{ base: 8, md: 10 }} py={{ base: 20, md: 28 }} direction={{ base: "column", md: "row" }}>
              <Stack flex={1} spacing={{ base: 5, md: 10 }}>
                ...
                <Text color={"gray.500"}>Choose from over 1 million apartments, houses, condos, and townhomes for rent.</Text>
                <Stack spacing={{ base: 4, sm: 6 }} direction={{ base: "column", sm: "row" }}>
                  ...
                  <Link
                    to="/AllListings"
                    className="transition-all inline-flex justify-center w-fit border border-red-300 shadow-sm px-4 py-3 text-md font-medium text-gray-50 hover:bg-red-600 hover:text-gray-950  bg-red-500 hover:font-bold mb-10 rounded-full cursor-pointer pt-2"
                    id="options-menu"
                    aria-haspopup="true"
                    aria-expanded="true"
                    href="#featured"
        ...
        <div className="px-2 overflow-x-none rounded">
          <div className="pb-2 px-2 py-2">
            <Stack flex={1} spacing={{ base: 5, md: 10 }}>
              <Stack spacing={{ base: 4, sm: 6 }} direction={{ base: "column", sm: "row" }}>
                <Button rounded={"full"} size={"lg"} fontWeight={"bold"} px={8} colorScheme={"red"} bg={"red.400"} _hover={{ bg: "red.500" }}>
                  Recent Listings
                </Button>
              </Stack>
            </Stack>
