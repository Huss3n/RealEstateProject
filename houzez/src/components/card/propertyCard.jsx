  ...
  return (
    <div className="shadow-md rounded-3xl overflow-hidden min-w-[300px]">
      {window.location.pathname === "/sell" ? (
        <img
          src={property.p_frontal_image.length > 0 ? property.p_frontal_image : "https://via.placeholder.com/400"}
      ...
      <div className="p-4">
        ...
        <div className="flex items-center mb-3">
          <div className="text-gray-400 lg:text-md md:text-sm font-medium text-xs pt-1">
